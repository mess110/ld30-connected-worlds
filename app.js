...
var animate, camera, cube, geometry, keyboard, lastTimeMsec, material, mesh, renderer, scene, updateFcts, zpotLight;
...
updateFcts.push(function(delta, now) {
  ...
  if (keyboard.pressed("d")) {
    return cube.position.x += cube.speed * delta;
  }
});
...
requestAnimationFrame(animate = function(nowMsec) {
  ...
  return updateFcts.forEach(function(updateFn) {
